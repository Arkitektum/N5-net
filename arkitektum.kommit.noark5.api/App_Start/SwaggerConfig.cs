...
using arkitektum.kommit.noark5.api;
...
namespace arkitektum.kommit.noark5.api
{
    public class SwaggerConfig
    {
                ...
                .EnableSwaggerUi( c =>
                    {
                        ...
                        //
                        //c.CustomAsset("index", thisAssembly, "arkitektum.kommit.noark5.api.res_swagger.index.html");
        ...
        {
            return string.Format(@"{0}\bin\arkitektum.kommit.noark5.api.XML",
